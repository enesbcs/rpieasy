...
#############################################################################
#
# Xiaomi Mijia LYWDS02 & LYWSD03 Bluetooth Clock+Temperature/Humidity Sensor plugin.
...
class Plugin(plugin.PluginProto):
 PLUGIN_ID = 513
 PLUGIN_NAME = "Environment - BLE Xiaomi LYWSD0x Clock&Hygrometer (EXPERIMENTAL)"
