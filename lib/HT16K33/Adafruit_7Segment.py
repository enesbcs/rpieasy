...
from lib.HT16K33.Adafruit_LEDBackpack import request_ht16_devices
...
#    self.disp = LEDBackpack(address=address, i2cbusnum, debug=debug)
    self.disp = request_ht16_devices(address,i2cbusnum)
